 $(document).ready(function () {
                ...
                $("#list1").jqGrid({
                    ...
                    colNames:["No Pendaftaran","Nama Lengkap","No Telp","Pilihan 1","Asal Sekolah","Cetak Form"],       //Grid column headings
                    colModel:[
                        ...
                        {name:"asal_sekolah",index:"asal_sekolah", width:20, align:"left"},
												 {name:"cetak_form",index:"no_pendaftaran",width:20,formatter:showlink}
                    ],
                    rownumbers:true,
                    rowNum:10,
	                  autowidth: true,
