              ...
              function createGrid(){
	              grid.jqGrid({
	                   url: base_url+"/loadDataGrid",     //another controller function for generating data
	                    ...
	                    colNames:["NPSN","NSS","Nama","Jenjang","Status","Kota","Kecamatan","Desa","Alamat","NIP Kepala Sekolah","Nama Kepala 
Sekolah","Status","Keterangan"],       //Grid column headings
	                    colModel:[
			                ...
			                var row =  grid.getGridParam("records");
				              $('.jqgrow').each(function(index,value){
					              var idRow = $(this).attr("id");
												var data = jQuery('#list1').jqGrid ('getCell', idRow, 
'keterangan');
